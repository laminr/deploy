...
use Rsv\DeployBundle\Form\CommandType;
...
class CommandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RsvDeployBundle:Command')->findAll();
     ...
     * @Method("POST")
     * @Template("RsvDeployBundle:Command:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RsvDeployBundle:Command')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RsvDeployBundle:Command:edit.html.twig")
     */
